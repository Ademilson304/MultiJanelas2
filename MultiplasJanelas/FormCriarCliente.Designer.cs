namespace MultiplasJanelas
{
    partial class FormCriarCliente
    {
        ...
        private void InitializeComponent()
        {
            ...
            textBoxUFCliente = new TextBox();
            textBoxCidadeCliente = new TextBox();
            label9 = new Label();
            textBoxCompleCliente = new TextBox();
            label8 = new Label();
            ...
            groupBox1.Controls.Add(textBoxCompleCliente);
            groupBox1.Controls.Add(label8);
            groupBox1.Controls.Add(textBoxNumCliente);
            groupBox1.Controls.Add(label7);
            groupBox1.Controls.Add(textBoxRuaCliente);
            ...
            textBoxCompleCliente.TabIndex = 3;
            // 
            // label8
            // 
        ...
        private TextBox textBoxUFCliente;
        private TextBox textBoxCidadeCliente;
        private TextBox textBoxCompleCliente;
