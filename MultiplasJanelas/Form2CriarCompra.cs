...
{
    public partial class Form2CriarCompra : Form
    {
        ...
        public Form2CriarCompra(BindingList<Fornecedor> fornecedores, BindingList<Produto> produtos)
        {
            InitializeComponent();
        ...
        private void Form2CriarCompra_Load(object sender, EventArgs e)
        {

        }

        private void button7Ok_Click(object sender, EventArgs e)
        {
            this.DialogResult = DialogResult.OK;
            this.Close();
        }

        private void button6Cancelar_Click(object sender, EventArgs e)
        {
