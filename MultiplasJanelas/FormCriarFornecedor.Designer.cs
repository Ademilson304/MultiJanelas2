...
{
    partial class FormCriarFornecedor
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            buttonOk = new Button();
            textBoxEmailFornecedor = new TextBox();
            textBoxTelefoneFornecedor = new TextBox();
            textBoxNomeFornecedor = new TextBox();
            groupBox1 = new GroupBox();
            textBoxCEPFornecedor = new TextBox();
            textBoxUFFornecedor = new TextBox();
            textBoxCidadeFornecedor = new TextBox();
            label9 = new Label();
            textBoxCompleFornecedor = new TextBox();
            label8 = new Label();
            textBoxNumFornecedor = new TextBox();
            label7 = new Label();
            textBoxRuaFornecedor = new TextBox();
            label4 = new Label();
            label6 = new Label();
            label5 = new Label();
            label3 = new Label();
            label2 = new Label();
            label1 = new Label();
            textBoxCNPJFornecedor = new TextBox();
            label10 = new Label();
            textBoxNomeContFornecedor = new TextBox();
            label11 = new Label();
            ...
            groupBox1.Controls.Add(textBoxCompleFornecedor);
            groupBox1.Controls.Add(label8);
            groupBox1.Controls.Add(textBoxNumFornecedor);
            groupBox1.Controls.Add(label7);
            groupBox1.Controls.Add(textBoxRuaFornecedor);
            ...
            // 
            textBoxCompleFornecedor.Location = new Point(115, 83);
            textBoxCompleFornecedor.Name = "textBoxCompleFornecedor";
            textBoxCompleFornecedor.Size = new Size(192, 23);
            textBoxCompleFornecedor.TabIndex = 3;
            // 
            // label8
            // 
            ...
            Controls.Add(textBoxCNPJFornecedor);
            Controls.Add(label10);
            Controls.Add(buttonCancel);
            Controls.Add(buttonOk);
            Controls.Add(textBoxEmailFornecedor);
            Controls.Add(textBoxTelefoneFornecedor);
        ...
        private TextBox textBoxCEPFornecedor;
        private TextBox textBoxUFFornecedor;
        private TextBox textBoxCidadeFornecedor;
        private Label label9;
        private TextBox textBoxCompleFornecedor;
        private Label label8;
        private TextBox textBoxNumFornecedor;
        private Label label7;
        private TextBox textBoxRuaFornecedor;
        ...
        private TextBox textBoxCNPJFornecedor;
        private Label label10;
        private TextBox textBoxNomeContFornecedor;
